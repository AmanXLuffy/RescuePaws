...
//     setFormData({ name: "", email: "", area: "", message: "", phone: "" }); 
//   };
  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col md:flex-row md:h-[700px] h-screen relative items-center">
        ...
        >
          <label className="text-2xl text-gray-700">Name</label>
          <input className="w-full h-[60px] text-black border-2 border-black rounded-lg mb-2 px-2"
            type="text"
            name="name"
            placeholder="Name"
            value={formData.name}
          ...
          <label className="text-2xl text-slate-600">Message</label>
          <textarea className="w-full h-[200px] text-black border-2 border-black rounded-lg mb-2 px-2"
            name="message"
